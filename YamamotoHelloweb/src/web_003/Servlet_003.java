...
@WebServlet(name = "/Servlet_007", urlPatterns = {
    "/web_003/Servlet_007"
})
  ...
  protected void doGet( HttpServletRequest request, HttpServletResponse response )
    ...
    if ( errMsg.size() == 0 ) {
      ...
      try {
        ...
        // 登録結果が無しであればエラーと見なす。
        // 登録結果0件の検知は、DBアクセッサでnullで仮置きで初期化する方法もある。
    ...
    // 結果画面への遷移
    request.setAttribute( "resultEntityList", resultEntityList );
    request.setAttribute( "errMsg", errMsg );
    RequestDispatcher rd = request.getRequestDispatcher( "/web_003/View_003_Output.jsp" );
