...
@WebServlet(name = "/Servlet_008", urlPatterns = {
    "/web_004/Servlet_008"
})
public class Servlet_001_main extends HttpServlet {
  ...
  protected void doGet( HttpServletRequest request, HttpServletResponse response )
    ...
    session.setAttribute( "resultEntity", resultEntity );
    session.setAttribute( "errMsg", errMsg );

    RequestDispatcher rd = request.getRequestDispatcher( "/web_004/View_001_Output.jsp" );
